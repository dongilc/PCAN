# Changelog
All notable changes to "PCAN-Basic Linux Package" will be documented in this file.
...
## [4.3.2] - 2019-10-08
### Added
- PCANBasic example now supports Python3.
- Added changelogs to subprojects (libpcanbasic, pcanbasic_java and libpcanbasic_jni).
### Changed
