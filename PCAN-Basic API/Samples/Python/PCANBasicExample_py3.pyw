...
################################################################################################################################################
    ...
    def InitializeConnectionWidgets(self):
        ...
        self.cbbBaudrates['selection']='1 MBit/sec'
    ...
    def InitializeReadingWidgets(self):
        ...
        if IS_WINDOWS:
            self.m_ListColSpace = [6, 10, 7, 6, 8, 20]
        else:
            self.m_ListColSpace = [6, 10, 7, 8, 13, 30]        
        
        self.m_ListCaptionPadxSpaces = []
        for colText, colWidth in zip(self.m_ListColCaption, self.m_ListColSpace):
            self.m_ListCaptionPadxSpaces.append(colWidth - len(colText) + 2)
