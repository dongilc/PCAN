...
#Region "Members"
    ...
    ''' </summary>
    Private m_NonPnPHandles() As TPCANHandle
#End Region
...
#Region "UI Handler"
    ...
    Private Sub btnHwRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnHwRefresh.Click
        ...
        Try
            For i As Integer = 0 To m_NonPnPHandles.Length - 1
...
#Region "Help functions"
    ...
    Private Sub InitializeBasicComponents()
        ...
        '
        m_NonPnPHandles = New TPCANHandle() {PCANBasic.PCAN_ISABUS1, PCANBasic.PCAN_ISABUS2, PCANBasic.PCAN_ISABUS3, PCANBasic.PCAN_ISABUS4, PCANBasic.PCAN_ISABUS5, PCANBasic.PCAN_ISABUS6,
         PCANBasic.PCAN_ISABUS7, PCANBasic.PCAN_ISABUS8, PCANBasic.PCAN_DNGBUS1}
