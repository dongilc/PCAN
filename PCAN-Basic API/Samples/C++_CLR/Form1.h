...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lbxInfo->Items->AddRange(gcnew cli::array< System::Object^  >(3) {L"Select a Hardware and a configuration for it. Then click \"Initialize\" button", 
			...
			this->cbbParameter->Items->AddRange(gcnew cli::array< System::Object^  >(21) {L"Device ID", L"5V Power", L"Auto-reset on BUS-OFF", 
				...
				L"Reception of Error Frames", L"Interframe Transmit Delay"});
